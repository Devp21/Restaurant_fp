            ...
            <div class="col-12 col-lg-2 text-center leftmenu pt-3 pt-lg-5">
                ...
                <nav>
                    <div class="nav flex-row flex-wrap flex-lg-column nav-tabs justify-content-center" id="nav-tab" role="tablist">
                        <div class="sidebar">
                            <a class ="nav-item nav-link active" href="starter.php">Starter</a>
                            ...
                            <a class ="nav-item nav-link" href="dessert.php">Desserts</a>
                            <a class ="nav-item nav-link">Billing</a>
                          </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav1">
                        ...
                        <h3>Order Details</h3>
                            ...
                            <div class = "d-flex flex-wrap justify-content-around align-items-center">
                                <?php
                                $query = "SELECT * FROM fooditems WHERE id LIMIT 0,10";
                                ...
                                <div class = "product">
                                    <form method="post" action="starter.php?action=add&id=<?php echo $row ["id"]; ?>">
                                        <div style="border:1px solid #333; background-color: #f1f1f1; border-radius: 5px;">
                                            <img src=<?php echo "/Achija_dev/starterimg/". $row ["image_url"]; ?> ><br />
